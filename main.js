  ...
  return `
    <div class="quote">
      ...
      <div class="quote__grid">
        ...
        <article class="quote-card"><div class="quote-card__top"><span>Estrategia de marca</span><strong>$12,000 MXN</strong></div><h3>Arquitectura de Marca y Estrategia Digital</h3><p>Definición de la estructura de marca y narrativa de CyC del Sureste y sus divisiones, traducida en una estrategia de comunicación digital orientada a posicionar la empresa.</p><small>Incluye lineamientos de contenido y coordinación con la responsable de publicaciones para asegurar que cada pieza refuerce el posicionamiento de la marca.</small></article>
      </div>
      <div class="quote__total"><div class="quote__total-copy"><p class="eyebrow">Total</p><h3>$26,000 MXN</h3><small>Precios más IVA</small></div><div class="quote__total-breakdown"><div><span>Subtotal</span><strong>$32,000 MXN</strong></div><div><span>Descuento de amigo</span><strong>-18.75%</strong></div><div><span>Ahorro aplicado</span><strong>$6,000 MXN</strong></div></div></div>
